---
title: "Credit Card Customer Churn Prediction"
...
```{r}
data <- read.csv('C://Users//pc//Documents//Masters_Statistical_Sciences//Module 3//Multivariate data analysis//Project//Dataset//BankChurners.csv//BankChurners.csv')
attach(data)
head(data)
```
```{r}
...
Data has 10127 rows and 21 columns.
